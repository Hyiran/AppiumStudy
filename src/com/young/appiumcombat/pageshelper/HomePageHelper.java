...
public class HomePageHelper
{
	...
	public static void waitHomeUI(AppiumUtil appiumUtil, int elementTimeOut)
	{
		...
		appiumUtil.waitForElementToLoad(elementTimeOut,
				HomePage.HP_BUTTON_ACADEMIC);
		appiumUtil
				.waitForElementToLoad(elementTimeOut, HomePage.HP_BUTTON_DICT);
		appiumUtil.waitForElementToLoad(elementTimeOut,
				HomePage.HP_BUTTON_IMAGE);
		appiumUtil
				.waitForElementToLoad(elementTimeOut, HomePage.HP_BUTTON_MORE);
		appiumUtil.waitForElementToLoad(elementTimeOut,
				HomePage.HP_BUTTON_VDEDIO);
	...
	public static void checkHomeUIText(AppiumUtil appiumUtil, String expected)
	{
		...
		appiumUtil.isTextCorrect(appiumUtil.getText(HomePage.HP_LINK_STORY),
				expected);

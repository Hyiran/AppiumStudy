...
public class ExcelDataProvider implements Iterator<Object[]>
{
	...
	{
		logger.info(this.getClass().getSimpleName() + "   hasNext invoked!");
	...
	public Object[] next()
	{
		logger.info(this.getClass().getSimpleName() + "    next invoked!");
		...
		for (int i = 0; i < this.columnNum; i++)
		{
			...
			try
			{
				temp = c[i].getContents().toString();	//根据excel里的key取到值 java
			}
		...
		object[0] = data;	//这里返回  {KEYWORD=Java}
		this.currentRowNo++;
		return object;
	}
	...
	public void remove()
	{
		logger.info(this.getClass().getSimpleName() + "    remove invoked!");

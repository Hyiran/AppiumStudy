...
public class LogConfiguration {
		...
		public static void initLog(String fileName){
			...
			prop.setProperty("log4j.appender.toConsole.layout.ConversionPattern","%l [%d{yyyy-MM-dd HH:mm:ss}] [%p] %m%n");		
			...
			prop.setProperty("log4j.appender.toFile.layout.ConversionPattern", "%l [%d{yyyy-MM-dd HH:mm:ss}] [%p] %m%n");
			//使配置生效

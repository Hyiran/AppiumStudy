...
public class BasePrepare
{
	...
	public Iterator<Object[]> dataFortestMethod() throws IOException
	{
		...
		{
			/**
			 * 这里的calssName原始值大概是这样的：com.young.appiumcombat.testcases.login.
			 * LoginPage_001_loginError_Test 那么下面这段代码className.substring(33,
			 * className.lastIndexOf("."))是什么意思？substring方法参数有两个
			 * 一个开始位置，一个结束位置，33
			 * 表示这个字符串的第33个位置，这个位置当前字符是l,className.lastIndexOf("."
			 * )表示返回这字符串最后一个.所在 的位置，它是38，那么className.substring(33,
			 * className.lastIndexOf("."))可以转换成：className.substring(33,
			 * 38)，最终取得的值是login， 也就是moduleName的值
			 * 
			 * 
			 * */
